export const indigoWebsiteContent = {
  ...
  home: {
    ...
    hero: {
      ...
      image: {
        src: '/images/hero.jpg',
        alt: 'Professional property service coordination',
      },
    },
    pathways: [
      {
        ...
        image: {
          ...
          alt: 'Commercial facility plumbing and service work',
        },
      },
      {
        title: 'Indigo Homes',
        ...
        image: {
          ...
          alt: 'Residential home repair and maintenance',
        },
      },
    ],
    services: [
    ...
    trust: {
      ...
      items: [
        'Phone: (512) 608-4999',
        'Public contact: support [at] call-indigo.com',
        'Address: 1005 Meredith Drive, Austin, TX 78748',
